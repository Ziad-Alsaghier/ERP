...
class CustomPageController extends Controller
{
    ...
    public function customPage($slug)
    {
        ...
        foreach ($pages as $key => $page) {
            if($page['page_slug'] == $slug){
                // dd($page);
                return view('landingpage::home.custom', compact('page', 'adminSettings','settings','logo','sup_logo','metatitle','metsdesc','meta_image','meta_logo','get_cookie','setting','SITE_RTL','color','themeColor'));
            }
        }
    ...
    public function contactPage(){
        ...
        return view('landingpage::home.contact', compact('adminSettings','settings','logo','sup_logo','metatitle','metsdesc','meta_image','meta_logo','get_cookie','setting','SITE_RTL','color','themeColor'));
    ...
    public function meetPage(){
        ...
        return view('landingpage::home.meet', compact('adminSettings','settings','logo','sup_logo','metatitle','metsdesc','meta_image','meta_logo','get_cookie','setting','SITE_RTL','color','themeColor'));
