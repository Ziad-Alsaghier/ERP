...
class PricingPlanController extends Controller
{
    ...
    public function pricePlan(){
        ...
        return view('landingpage::home.pricePlan',compact('adminSettings','settings','logo','sup_logo','metatitle','metsdesc','meta_image','meta_logo','get_cookie','setting','SITE_RTL','color','themeColor'));
    }
}
}
