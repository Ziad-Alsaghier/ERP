            ...
            <div class="col-sm-6 col-md-6 col-lg-6 col-xl-6">
              <div class="single-service">
                ...
                <div class="service-content">
                  <h4>App design</h4>
                  <p>
                    Maecenas ut est in ante imperdiet laoreet eu quis
                    vehicula justo elit Phasellus Door
                  </p>
            ...
            <ul class="nav nav-pills gap-3 mb-3" id="pills-tab" role="tablist">
              <li class="nav-item" role="presentation">
                <button class="nav-link active" id="pills-home-tab" data-bs-toggle="pill" data-bs-target="#pills-home"
                  type="button" role="tab" aria-controls="pills-home" aria-selected="true">Pay Monthly</button>
              </li>
              <li class="nav-item" role="presentation">
                <button class="nav-link" id="pills-profile-tab" data-bs-toggle="pill" data-bs-target="#pills-profile"
                  type="button" role="tab" aria-controls="pills-profile" aria-selected="false">Pay Yearly</button>
              </li>
              <li class="nav-item">
                <button class="nav-link" id="currency-switch" data-bs-toggle="pill" data-bs-target="#pills-currency"
                  type="button" role="tab" aria-controls="pills-profile" aria-selected="false">USD</button>
              </li>
            </ul>
          </div>
                  ...
                  <div class="col-md-6 col-lg-4 col-xl-4">
                    <div class="single-price-box">
                      ...
                      <h2 class="dollar d-none">
                        {{ isset($admin_payment_setting['currency_symbol']) ? $admin_payment_setting['currency_symbol'] : '$' }}{{ intval($value->price) }}/<sub>{{ $value->duration }}</sub>
                      </h2>
                      @foreach ($rates as $currencyCode => $rate)
                        <h2 class="pound-egy">
                          {{ $currencyCode }}{{ intval($value->price * $data['rates']['EGP'] + 5) }}/<sub>{{ $value->duration }}</sub>
                        </h2>
      ...
      <div class="row">
        <div class="col-md-12 col-lg-12 col-xl-12">
          ...
          <div class="video-demo" style="height: 500px;">
            <img src="assets/img/play-video.jpg" alt style="height: 500px;" />
            <div class="play-btn">
              <a class="popup-video" href="https://www.youtube.com/watch?v=0O2aH4XLbto"><i class="fas fa-play"></i> Play
                now</a>
            </div>
          </div>
        </div>
