    ...
    @endif
                ...
                <div class="container text-center">
                    <div class="row align-items-center">
                        <div class="col-12 align-self-center landing_heading mt-5">
                            <h1 class="mb-3">{{ $settings['home_heading'] }}</h1>
                            <h5 class="mb-0">{{ $settings['home_description'] }}</h5>
                    ...
                    <div class="col-xxl-9">
                        <div class="row gy-3 row-cols-9">
                            @foreach (explode(',', $settings['home_logo']) as $k => $home_logo)
                                ...
                                <div class="col-auto">
                                    <img src="{{ $logo . '/' . $home_logo }}" alt="" class="landing_logo" style="width: 130px;">
                                </div>
                            @endforeach
                        </div>
                    </div>
                ...
                <div class="container">
                    <div class="row gy-3">
                        ...
                        <div class="col-xxl-8">
                            <div class="row">
                                @if (
                                        is_array(json_decode($settings['feature_of_features'], true)) ||
        ...
        @if ($settings['feature_status'] == 'on' && $settings['other_features'] !== "[]")
            <section class="element-section  section-gap ">
                <div class="container">
                    @if (
                            is_array(json_decode($settings['other_features'], true)) ||
        ...
        @if ($settings['discover_status'] == 'on' && $settings['discover_of_features'] !== "[]")
            <section class="bg-dark section-gap" id="discover">
                <div class="container">
                    ...
                    <div class="row">
                        @if (
                                is_array(json_decode($settings['discover_of_features'], true)) ||
        ...
        @if ($settings['plan_status'])
            <section class="subscription bg-gray-200 section-gap" id="plan">
                <div class="container">
                        ...
                        <div class="row justify-content-end">
                            <div class="col-auto">
                                <div class="form-check form-switch custom-switch-v1 d-flex align-items-center">
                                    <h6 class="m-2 text-secondary" id="filt-monthly">Monthly</h6>
                                    <div class="toggle">
                                        <input type="checkbox" id="switcher" class="check" checked>
                                        <b class="b switch"></b>
                                    </div>
                                    <h6 class="m-2" id="filt-yearly">Yearly</h6>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="row justify-content-center d-none" id="monthly">
                        @foreach ($collection as $key => $value)
                            @if ($value->duration == "month")
                    ...
                    <div class="row justify-content-center" id="yearly">
                        <!-- [ Yearly Plans ] Start -->
                        @foreach ($collection as $key => $value)
                                ...
                                <div class="col-12" style="width: 75%;">
                                    <div class="card price-card shadow-none">
                                        <div class="card-body">
                                            ...
                                            <div class="row">
                                                <div class="col-4">
                                                    <span class="mb-4 p-price" style="font-size: 50px;font-weight: 800;">جرب الان
                                                        مجاناً</span>
                                                    <p>{!! $value->description !!}</p>
                                                </div>
                                                <div class="col ">
                                                    <div class="row align-items-center pb-5" style="height:70%;">
                                                        <div class="col-4 form-check text-start">
                                                            <label class="form-check-label"
                                                                for="customCheckc1">{{ $value->max_users == -1 ? 'Unlimited' : $value->max_users }}
                                                                {{ __('User') }}</label>
                                                        </div>
