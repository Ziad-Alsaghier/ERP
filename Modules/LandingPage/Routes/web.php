...
Route::get('contact/', 'CustomPageController@contactPage')->name('contact.page')->middleware('XSS');
Route::post('join_us/store/', 'JoinUsController@joinUsUserStore')->name('join_us_store');
Route::get('price-plans','PricingPlanController@pricePlan')->name('pricePlan')->middleware('XSS');
Route::get('meet-form', 'CustomPageController@meetPage')->name('meet.page')->middleware('XSS');
