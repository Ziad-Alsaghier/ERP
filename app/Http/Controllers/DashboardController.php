...
class DashboardController extends Controller
{
    ...
    public function landingPage()
    {
        ...
        if ($adminSettings['display_landing_page'] == 'on' && \Schema::hasTable('landing_page_settings')) {
            ...
            return view('landingpage::home.land' , compact('adminSettings','settings','logo','sup_logo','metatitle','metsdesc','meta_image','meta_logo','get_cookie','setting','SITE_RTL','color','themeColor'));
        } else {
    ...
    public function account_dashboard_index()
    {
        if (Auth::check()) {
            ...
            if (Auth::user()->type == 'super admin') {
                ...
                if(\Auth::user()->plan == 0 && \Auth::user()->plan !== null){
