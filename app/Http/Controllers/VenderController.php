...
class VenderController extends Controller
{
    ...
    public function index()
    {
        ...
        {
            $venders = Vender::where('created_by', \Auth::user()->creatorId())->orderBy('id', 'desc')->get();
    ...
    {
        $latestVenderId = Vender::where('created_by', '=', \Auth::user()->creatorId())->max('vender_id');
