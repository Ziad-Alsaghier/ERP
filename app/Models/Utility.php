...
class Utility extends Model
{
    ...
    public static function getSettingssss($id)
    {
        if (self::$getsettings == null) {
            $data = DB::table('settings');
    ...
    public static function settings()
    {
        ...
        $settings = [
            "site_currency" => ["USD" => 1, "EGP" => 50],
            "site_currency_symbol" => "$",
            "site_currency_symbol_position" => ["USD" => "pre", "EGP" => "post"],
            ...
            "company_city_bill" => "",
            "company_state_bill" => "",
            "company_zipcode_bill" => "",
            "company_country_bill" => "",
            "company_telephone_bill" => "",
            "company_telephone_bill_another" => "",
            "email_bill" => "",
            "email_bill_another" => "",
            "social_link_bill" => "",
            "header_bill" => "",
    ...
    public static function templateData()
    {
        ...
        $arr['colors'] = [
            ...
            '511378',
            '002336',
            // '0f3866', Change Color Design For Iframe
            '48c0b6',
            '297cc0',
            'ffffff',
            '000',
    ...
    public static function ordersNumberFormat($number)
    {
        return '#REFS' . sprintf("%05d", $number);
    }
    ...
    // public static $chartOfAccountMiniTypes = array(
    //     "assets"
    // );

    public static $chartOfAccountParents = array(
        [
            "name" => "Depreciation",
            "sub_type" => "Operational Cost",
            "type" => "Expenses",
    ...
    // added by muhammed 8/10
    public static $chartOfAccountMiniTypes = array(
        ['name' => 'Accounts Receivable', 'subtype' => 'Current Assets'],
        ['name' => 'Bank Account', 'subtype' => 'Current Assets'],
        ['name' => 'Employees Advances', 'subtype' => 'Current Assets'],
        ['name' => 'Inventory', 'subtype' => 'Current Assets'],
        ['name' => 'Non-bank Cash and Equivalents', 'subtype' => 'Current Assets'],
        ['name' => 'Other Current Assets', 'subtype' => 'Current Assets'],
        ['name' => 'Petty Cash', 'subtype' => 'Current Assets'],
        ['name' => 'Prepaid Expenses and Others', 'subtype' => 'Current Assets'],
        ['name' => 'Assets Spare Parts Inventory', 'subtype' => 'Current Assets'],

        ['name' => 'Intangible Assets', 'subtype' => 'Non-current assets'],
        ['name' => 'Other Fixed Assets', 'subtype' => 'Non-current assets'],
        ['name' => 'Property, Plant, and Equipment', 'subtype' => 'Non-current assets'],
        ['name' => 'Investing in Other Companies', 'subtype' => 'Non-current assets'],
        ['name' => 'Work in Progress', 'subtype' => 'Non-current assets'],

        ['name' => 'Accounts Payable', 'subtype' => 'Current Liability'],
        ['name' => 'Accrued Expenses', 'subtype' => 'Current Liability'],
        ['name' => 'Accrued Salaries and Amounts Owed to Employees', 'subtype' => 'Current Liability'],
        ['name' => 'Accumulated Depreciation', 'subtype' => 'Current Liability'],
        ['name' => 'Accumulated Amortization', 'subtype' => 'Current Liability'],
        ['name' => 'Allowance for Doubtful Accounts', 'subtype' => 'Current Liability'],
        ['name' => 'Other Current Liability', 'subtype' => 'Current Liability'],
        ['name' => 'Provisions', 'subtype' => 'Current Liability'],
        ['name' => 'Short-term Borrowings', 'subtype' => 'Current Liability'],
        ['name' => 'Taxes Payable', 'subtype' => 'Current Liability'],
        ['name' => 'Unearned Revenues', 'subtype' => 'Current Liability'],
        ['name' => 'Zakat Payable', 'subtype' => 'Current Liability'],
        ['name' => 'VAT Payable', 'subtype' => 'Current Liability'],
        ['name' => 'Interest Payable', 'subtype' => 'Current Liability'],
        ['name' => 'Current Part of Long-term Borrowings', 'subtype' => 'Current Liability'],

        ['name' => 'Long-term Borrowings', 'subtype' => 'Non-current Liability'],
        ['name' => 'Other Non-current Liabilities', 'subtype' => 'Non-current Liability'],
        ['name' => 'End of Service Benefits', 'subtype' => 'Non-current Liability'],
        ['name' => 'Retention', 'subtype' => 'Non-current Liability'],

        ['name' => 'Additional paid-in capital', 'subtype' => 'Issued Capital'],
        ['name' => 'Employees Equity', 'subtype' => 'Issued Capital'],
        ['name' => 'Registered capital', 'subtype' => 'Issued Capital'],

        ['name' => 'Other equity', 'subtype' => 'Other equity'],
        ['name' => 'Reserves', 'subtype' => 'Other equity'],
        ['name' => 'Other equity', 'subtype' => 'Reserve'],
        ['name' => 'Reserves', 'subtype' => 'Reserve'],
        ['name' => 'Retained earnings', 'subtype' => 'Retained earnings or losses'],
        ['name' => 'Dividends', 'subtype' => 'Retained earnings or losses'],

        ['name' => 'Sales', 'subtype' => 'Operational Revenue'],

        ['name' => 'Other Revenue', 'subtype' => 'Non-operating revenues'],
        ['name' => 'Gain/losses on sales of equipment', 'subtype' => 'Non-operating revenues'],
        ['name' => 'Gain/losses on sales of intangible assets', 'subtype' => 'Non-operating revenues'],

        ['name' => 'Cost of sales', 'subtype' => 'Direct Cost'],
        ['name' => 'Other Direct Cost', 'subtype' => 'Direct Cost'],

        ['name' => 'Amortization', 'subtype' => 'Operational Cost'],
        ['name' => 'Depreciation', 'subtype' => 'Operational Cost'],
        ['name' => 'Employee incentives and benefits', 'subtype' => 'Operational Cost'],
        ['name' => 'General and Administrative', 'subtype' => 'Operational Cost'],
        ['name' => 'Marketing', 'subtype' => 'Operational Cost'],
        ['name' => 'Other Operational Cost', 'subtype' => 'Operational Cost'],
        ['name' => 'Salaries', 'subtype' => 'Operational Cost'],
        ['name' => 'Technical and Consulting Expenses', 'subtype' => 'Operational Cost'],
        ['name' => 'Change in currency value gains or losses', 'subtype' => 'Operational Cost'],
        ['name' => 'Research & Development', 'subtype' => 'Operational Cost'],


        ['name' => 'Change in currency value gains or losses', 'subtype' => 'Non- Operational Expenses'],
        ['name' => 'Taxes', 'subtype' => 'Non- Operational Expenses'],
        ['name' => 'Zakat', 'subtype' => 'Non- Operational Expenses'],
        ['name' => 'Interest Expenses', 'subtype' => 'Non- Operational Expenses'],
    ...
    public static function chartOfAccountTypeData($company_id)
    {
        ...
        foreach ($chartOfAccountTypes as $k => $type) {
            ...
            foreach ($chartOfAccountSubTypes[$k] as $subType) {
                $createdSubType = ChartOfAccountSubType::create(
                    [
                        'name' => $subType,
                        'type' => $accountType->id,
                        'created_by' => $company_id,
                ...
                //added by muhammed 8/10
                $chartOfAccountMiniTypes = self::$chartOfAccountMiniTypes;
                foreach ($chartOfAccountMiniTypes as $miniType) {
                    if ($miniType['subtype'] === $createdSubType->name) {
                        ChartOfAccountMiniType::create(
                            [
                                'name' => $miniType['name'],
                                'sub_type' => $createdSubType->id,
                                'created_by' => $company_id,
                            ]
                        );
                    }
    ...
    public static $chartOfAccount1 = array(
        [
            ...
            "type" => "Assets",
            "sub_type" => "Current Assets",
            "description" => "Cash and Equivalents (cash & Petty Cash)"
        ],
        [
            "name" => "Cash in bank",
            "code" => "1102",
        ...
        [
            ...
            "type" => "Assets",
            "sub_type" => "Current Assets",
            "description" => "money due to a firm for goods or services delivered or used but not yet paid for by customers"
        ],
        [
            "name" => "Prepaid expenses",
            "code" => "1104",
            "type" => "Assets",
            "sub_type" => "Current Assets",
            "description" => "Amount paid in advance to get the service or product to be received in the future, for example Medical insurance, staff advances & office rent"
        ],
        [
            "name" => "Staff advances",
            "code" => "1105",
            "type" => "Assets",
            "sub_type" => "Current Assets",
            "description" => "Loan by the employer to employee who's obligated to payback"
        ],
        [
            "name" => "Inventory",
            "code" => "1106",
            "type" => "Assets",
            "sub_type" => "Current Assets",
            "description" => "Inventory (includes the raw materials & products )"
        ],
        [
            "name" => "PPE",
            "code" => "1201",
        ...
        [
            ...
            "type" => "Assets",
            "sub_type" => "Non-current assets",
            "description" => "Goodwill, patents, copyrights & trademarks"
        ],
        [
            ...
            "type" => "Assets",
            "sub_type" => "Non-current assets",
            "description" => "Property purchased with intention of earning a return either through rent, future resale, or both."
        ],
        [
            ...
            "type" => "Liability",
            "sub_type" => "Current Liability",
            "description" => "Amount the organization is owed to a supplier or vendor for a product or service has been received"
        ],
        [
            ...
            "type" => "Liability",
            "sub_type" => "Current Liability",
            "description" => "Accrued expenses not booked or paid yet"
        ],
        [
            ...
            "type" => "Liability",
            "sub_type" => "Current Liability",
            "description" => "Accrued salaries not paid yet"
        ],
        [
            ...
            "type" => "Liability",
            "sub_type" => "Current Liability",
            "description" => "Amount borrowed and paid back in less than a year or Financial period which longer"
        ],
        [
            "name" => "VAT payable",
            "code" => "2105",
            "type" => "Liability",
            "sub_type" => "Current Liability",
            "description" => "VAT payable to GAZT"
        ],
        [
            "name" => "Accrued Taxes",
            "code" => "2106",
            "type" => "Liability",
            "sub_type" => "Current Liability",
            "description" => "Foreign Companies Accrued Taxes"
        ],
        [
            ...
            "type" => "Liability",
            "sub_type" => "Current Liability",
            "description" => "Amount received for a service or product that has yet to be provided or delivered"
        ],
        [
            ...
            "type" => "Liability",
            "sub_type" => "Current Liability",
            "description" => "Amount Due to GOSI"
        ],
        [
            "name" => "Accumulated Depreciation",
            "code" => "2109",
        ...
        [
            ...
            "description" => "Long term loans to be paid after more than one year"
        ],
        [
            ...
            "type" => "Liability",
            "sub_type" => "Non-current Liability",
            "description" => "End of Services Provision"
        ],
        [
            "name" => "Registered capital",
            "code" => "3101",
            "type" => "Equity",
            "sub_type" => "Issued Capital",
            "description" => "Capital registered in Commercial Registration Doc. CR"
        ],
        [
            ...
            "type" => "Equity",
            "sub_type" => "Issued Capital",
            "description" => "Additional capital paid by owners to increase the equity"
        ],
        [
            "name" => "Opening balance",
            "code" => "3201",
            "type" => "Equity",
            "sub_type" => "Other equity",
        ...
        [
            ...
            "type" => "Equity",
            "sub_type" => "Reserve",
            "description" => "Amount set aside to meet organization obligation"
        ],
        [
            ...
            "type" => "Equity",
            "sub_type" => "Reserve",
            "description" => "Difference between the translated values of any asset/liability at EOM rate and historical rate"
        ],
        [
            "name" => "Profit and loss",
            "code" => "3401",
            "type" => "Equity",
            "sub_type" => "Retained earnings or losses",
            "description" => "Profit and loss of the current financial period"
        ],
        [
            ...
            "type" => "Equity",
            "sub_type" => "Retained earnings or losses",
            "description" => "Amount from Net income is held or retained from net income and saved for future"
        ],
        [
            "name" => "Revenue of Products and services Sales",
            "code" => "4101",
            "type" => "Revenue",
            "sub_type" => "Operational Revenue",
            "description" => "Income generated from selling a product/ service"
        ],
        [
            "name" => "Other income",
            "code" => "4201",
            "type" => "Revenue",
            "sub_type" => "Non-operating revenues",
            "description" => "Income generated from activities not related to its core business operation"
        ],
        [
            "name" => "Cost of goods sold",
            "code" => "5101",
            "type" => "Expenses",
            "sub_type" => "Direct Cost",
        ...
        [
            ...
            "type" => "Expenses",
            "sub_type" => "Direct Cost",
            "description" => "Salary cost for the employees working in the operation (factory, shop ...)"
        ],
        [
            ...
            "type" => "Expenses",
            "sub_type" => "Direct Cost",
            "description" => "Commission based on sales"
        ],
        [
            ...
            "type" => "Expenses",
            "sub_type" => "Direct Cost",
            "description" => "Shipping and custom fees for Imported products"
        ],
        [
            ...
            "type" => "Expenses",
            "sub_type" => "Operational Cost",
            "description" => "For the employees working in head office"
        ],
        [
            ...
            "type" => "Expenses",
            "sub_type" => "Operational Cost",
            "description" => "Medical Insurance and treatment"
        ],
        [
            ...
            "type" => "Expenses",
            "sub_type" => "Operational Cost",
            "description" => "Marketing & Advertising expenses"
        ],
        [
        ...
        [
            ...
            "type" => "Expenses",
            "sub_type" => "Operational Cost",
            "description" => "a percentage of GOSI Subscription paid monthly"
        ],
        [
            ...
            "type" => "Expenses",
            "sub_type" => "Operational Cost",
            "description" => "For Example CR Renewal & Chamber of commerce stamp"
        ],
        [
        ...
        [
            ...
            "type" => "Expenses",
            "sub_type" => "Operational Cost",
            "description" => "Water, electricity, telephone & Internet bills"
        ],
        [
        ...
        [
            ...
            "type" => "Expenses",
            "sub_type" => "Operational Cost",
            "description" => "Hospitality & cleanliness"
        ],
        [
            ...
            "type" => "Expenses",
            "sub_type" => "Operational Cost",
            "description" => "Any Bank fees like transfer fees, interest & stamped Statement"
        ],
        [
            "name" => "Other expenses",
            "code" => "5214",
        ...
        [
            ...
            "type" => "Expenses",
            "sub_type" => "Operational Cost",
            "description" => "Transportation expense (Fuel, Taxi)"
        ],
        [
            "name" => "Zakat",
            "code" => "5301",
            "type" => "Expenses",
            "sub_type" => "Non- Operational Expenses",
            "description" => "Zakat for GAZT"
        ],
        [
            "name" => "TAX",
            "code" => "5302",
        ...
        [
            ...
            "type" => "Expenses",
            "sub_type" => "Non- Operational Expenses",
            "description" => "Gain/losses of foreign currency change"
        ],
        [
            "name" => "Interest",
            "code" => "5304",
            "type" => "Expenses",
            "sub_type" => "Non- Operational Expenses",
            "description" => "Bank interests"
        ]
    );

    //added by muhammed 10/8
    public static $chartOfAccount2 = array(
        [
            "name" => "Cash and equivalents",
            "code" => "1101",
            "type" => "Assets",
            "sub_type" => "Current Assets",
            "description" => "Cash and Equivalents (cash & Petty Cash)",
            "mini_type" => "Non-bank Cash and Equivalents"
        ],
        [
            "name" => "Cash in bank",
            "code" => "1102",
        ...
        [
            ...
            "sub_type" => "Current Assets",
            "description" => "Amount paid in advance to get the service or product to be received in the future, for example Medical insurance, staff advances & office rent",
            "mini_type" => "Prepaid Expenses and Others"
        ],
        [
            "name" => "Staff advances",
            "code" => "1105",
        ...
        [
            ...
            "sub_type" => "Non-current assets",
            "description" => "Property, plant, and equipment",
            "mini_type" => "Property, Plant, and Equipment"
        ],
        [
            "name" => "Intangible assets",
            "code" => "1202",
        ...
        [
            ...
            "sub_type" => "Current Liability",
            "description" => "Accrued salaries not paid yet",
            "mini_type" => "Accrued Salaries and Amounts Owed to Employees"
        ],
        [
            "name" => "Short-term loans",
            "code" => "2104",
            ...
            "sub_type" => "Current Liability",
            "description" => "Amount borrowed and paid back in less than a year or Financial period which longer",
            "mini_type" => "Short-term Borrowings"
        ],
        [
            "name" => "VAT payable",
            "code" => "2105",
        ...
        [
            ...
            "sub_type" => "Current Liability",
            "description" => "Amount Due to GOSI",
            "mini_type" => "Other Current Liability"
        ],
        [
            "name" => "Accumulated Depreciation",
            "code" => "2109",
            ...
            "sub_type" => "Current Liability",
            "description" => "Accumulated asset depreciation",
            "mini_type" => "Accumulated Depreciation"
        ],
        [
            "name" => "Long-term loans",
            "code" => "2201",
            ...
            "sub_type" => "Non-current Liability",
            "description" => "Long term loans to be paid after more than one year",
            "mini_type" => "Long-term Borrowings"
        ],
        [
            "name" => "End of Services Provision",
            "code" => "2202",
            ...
            "sub_type" => "Non-current Liability",
            "description" => "End of Services Provision",
            "mini_type" => "End of Service Benefits"
        ],
        [
            "name" => "Registered capital",
            "code" => "3101",
        ...
        [
            ...
            "sub_type" => "Issued Capital",
            "description" => "Additional capital paid by owners to increase the equity",
            "mini_type" => "Additional paid-in capital"
        ],
        [
            "name" => "Opening balance",
            "code" => "3201",
        ...
        [
            ...
            "sub_type" => "Operational Cost",
            "description" => "Medical Insurance and treatment",
            "mini_type" => "General and Administrative"
        ],
        [
            "name" => "Marketing and advertising",
            "code" => "5203",
        ...
        [
            ...
            "sub_type" => "Operational Cost",
            "description" => "For the employees working in head office",
            "mini_type" => "Employee incentives and benefits"
        ],
        [
            "name" => "Travel Expenses",
            "code" => "5206",
        ...
        [
            ...
            "sub_type" => "Non- Operational Expenses",
            "description" => "Gain/losses of foreign currency change",
            "mini_type" => "Change in currency value gains or losses"
        ],
        [
            "name" => "Interest",
            "code" => "5304",
    ...
    public static function chartOfAccountData1($user)
    {
        ...
        foreach ($chartOfAccounts as $account) {
            ...
            //added muhammed 8/10
            $mini_type = ChartOfAccountMiniType::where('sub_type', $sub_type->id)->where('name', $account['mini_type'])->first();
    ...
    public static function CreateTaxesAndUnits($user)
    {
        $taxes = [
            [
                'name' => 'VAT',
    ...
    public static function CreateCategories($user)
    {
        $income = ChartOfAccount::where('name', '=', 'Revenue of Products and services Sales')->where('created_by', '=', $user)->first();
        $expense = ChartOfAccount::where('name', '=', 'Cost of goods sold')->where('created_by', '=', $user)->first();

        $assets = ChartOfAccount::where('name', '=', 'Inventory')->where('created_by', '=', $user)->first();
        $liability = ChartOfAccount::where('name', '=', 'VAT payable')->where('created_by', '=', $user)->first();
        $equity = ChartOfAccount::where('name', '=', 'Registered capital')->where('created_by', '=', $user)->first();
        $categories = [
            [
                'name' => 'Income',
                'type' => 'income',
                'chart_account' => $income->id,
                'color' => 'FFFFFF',
            ],
            [
                'name' => 'Expenses',
                'type' => 'expense',
                'chart_account' => $expense->id,
                'color' => 'FFFFFF',
            ],
            [
                'name' => 'Assets',
                'type' => 'assets',
                'chart_account' => $assets->id,
                'color' => 'FFFFFF',
            ],
            [
                'name' => 'Liability',
                'type' => 'liability',
                'chart_account' => $liability->id,
                'color' => 'FFFFFF',
            ],
            [
                'name' => 'Equity',
                'type' => 'equity',
                'chart_account' => $equity->id,
                'color' => 'FFFFFF',
            ],
            [
        ...
        foreach ($categories as $cate) {
            ProductServiceCategory::create([
                ...
                'type' => $cate['type'],
                'def' => 1,
                'chart_account_id' => $cate['chart_account'],
                'created_by' => $user,
            ]);
        }
    }
    ...
    public static function createcustomer($id)
    {
        Customer::create(
            [
                ...
                'billing_state' => 'state',
                'billing_city' => 'city',
                'billing_phone' => 213543454,
                'billing_zip' => 849816,
                'billing_address' => 'shipping name',
                'shipping_name' => 'shipping name',
                'shipping_country' => 'country',
                'shipping_state' => 'state',
                'shipping_city' => 'city',
                'shipping_phone' => 848498494,
                'shipping_zip' => 849816,
    ...
    public static function createvendor($id)
    {
        Vender::create(
            [
                'name' => 'Demo Vender',
    ...
    {
        $productandservice = ProductServiceUnit::where('name', '=', 'Piece')->where('created_by', '=', $id)->first();
    ...
    public static function colorset()
    {
        if (\Auth::check()) {
            ...
            if (!$user) {
                return Utility::settings(); // fallback
            }
            ...
            if (!empty($settings['storage_setting'])) {
                ...
                if ($validator->fails()) {
                    ...
                    if ($settings['storage_setting'] == 'local') {
                        ...
                        // dd($request->$key_name->move('../storage/'.$path, $name));

                        $request->$key_name->move('storage/' . $path, $name);
                        $path = $path . $name;
    ...
    public static function getAccountData($account_id, $start_date = null, $end_date = null, $customer = null)
    {
        ...
        $transactionData = DB::table('transaction_lines')
            ...
            ->select(
                ...
                DB::raw("COALESCE(invoices.invoice_id, bills.bill_id , bank_accounts.id) as ids")
            );
        if ($customer !== null) {
            $transactionData = $transactionData->where('customers.id', $customer);
        }
    ...
    public static function addTransactionLines($data)
    {
        ...
        //     ->where('transaction_amount', $data['transaction_amount'])
        //     ->first();
    ...
    /**                          MOMEN MOHSEN NEW FUNCTION
     *                                 [2025-1-22]
     * Name : recording Data Default in the system
     * Initializes default data for a user by registering various settings and templates.
     *
     * This function sets up default data for a user identified by $user_id. It registers
     * default data such as user information, warehouse, bank accounts, and various templates
     * including offer letters, experience certificates, joining letters, and No Objection Certificates.
     * It also configures financial data like account types, tax units, and project stages.
     *
     * param int $user_id The unique identifier for the user to initialize default data for.
     */

    public static function recordingDataDefault($user_id)
    {
        User::userDefaultDataRegister($user_id);
        User::userWarehouseRegister($user_id);
        User::userDefaultBankAccount($user_id);
        Utility::chartOfAccountTypeData($user_id);
        Utility::chartOfAccountData1($user_id);
        Utility::CreateTaxesAndUnits($user_id);
        Utility::CreateCategories($user_id);
        ...
        Utility::createcustomer($user_id);
        Utility::createvendor($user_id);
        Utility::createproduct($user_id);
