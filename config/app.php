...
return [
    ...
    */
    ...
    'name' => env('APP_NAME', 'The Future ERP'),
    'website_storage'=> 'https://hololpack.com/storage/',
    /*
    |--------------------------------------------------------------------------
    ...
    */
    ...
    'url' => env('APP_URL', 'http://localhost/thefuture-erp/'),
    ...
    */
    ...
    'key' => env('APP_KEY','base64:uRv0CHR/k38V54hMDA4xNKaBuK+ON2XqSneGA6kVGrU='),

    'cipher' => 'AES-256-CBC',
    "InvoiceType" => 'reporting:1.0', // standard or simplified
