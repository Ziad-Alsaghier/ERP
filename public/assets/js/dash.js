...
// =======================================================
// =======================================================
// Select all elements with the class 'choices__input'

    // const choicesInputs = document.querySelectorAll('.choices__input');
    // choicesInputs.forEach(input => {
    //     // Check if the parent select element has the 'required' attribute
    //     const selectElement = input.closest('select');
    //     if (selectElement && selectElement.hasAttribute('required')) {
    //         // Create the new div element
    //         const invalidFeedback = document.createElement('div');
    //         invalidFeedback.className = 'invalid-feedback'; // Set the class
    //         invalidFeedback.textContent = 'Please select an option.'; // Set the text content

    //         // Hide the element initially using style.display
    //         invalidFeedback.style.display = 'none';

    //         // Insert the new div after the .choices__input element
...
// const choicesInputs = document.querySelectorAll('.choices__input');
// choicesInputs.forEach(input => {
//     const choicesWrapper = input.closest('.choices'); // العنصر المغلف (الذي يمكن إعطاؤه إطار أحمر)
...
//         // إدراج رسالة الخطأ بعد الـ wrapper وليس بعد input
//         choicesWrapper.insertAdjacentElement('afterend', invalidFeedback);

//         // تابع للتحقق من صحة الحقل عند الإرسال
//         selectElement.closest('form')?.addEventListener('submit', function (e) {
//             if (!selectElement.value) {
//                 e.preventDefault();

//                 // إضافة class للإطار الأحمر
...
const choicesInputs = document.querySelectorAll('.choices__input');
choicesInputs.forEach(input => {
    const choicesWrapper = input.closest('.choices'); // الحاوية التي تحاوط الـ select
    const selectElement = choicesWrapper?.querySelector('select');

    if (selectElement && selectElement.hasAttribute('required')) {
        // تحقق إذا كان العنصر بالفعل يحتوي على رسالة خطأ
        let existingFeedback = choicesWrapper.nextElementSibling;
        if (!existingFeedback || !existingFeedback.classList.contains('invalid-feedback')) {
            // إنشاء الرسالة فقط إذا لم تكن موجودة
            const invalidFeedback = document.createElement('div');
            invalidFeedback.className = 'invalid-feedback';
            // invalidFeedback.textContent = 'Please select an option.';
            invalidFeedback.style.display = 'none';
        ...
        const feedback = choicesWrapper.nextElementSibling;
        ...
        // إزالة الخطأ عند تغيير الاختيار
