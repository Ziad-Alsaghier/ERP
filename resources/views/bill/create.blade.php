...
@section('content')
<div class="row">
    {{ Form::open(['url' => 'bill', 'class' => 'w-100 needs-validation', 'id' => 'billform', 'novalidate']) }}
    <div class="col-12">
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="form-group" id="vender-box">
                            ...
                            {{ Form::select('vender_id', $venders, $vendorId, [
                                'class' => 'form-control form-select' . ($errors->has('vender_id') ? ' is-invalid' : ''),
                                'id' => 'vender',
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    {{ Form::date('bill_date', null, [
                                        'class' => 'form-control' . ($errors->has('bill_date') ? ' is-invalid' : ''),
                                        'required' => 'required'
                                    ]) }}
                                    <div class="invalid-feedback">Please enter a valid bill date.</div>
                                    @error('bill_date')
                        ...
                        <tbody class="ui-sortable" data-repeater-item>
                            ...
                            <tr>
                                <td width="25%" class="form-group pt-0">
                                    {{ Form::select('item', $product_services,'', array('class' => 'form-control select2  ','id'=>'asset_account','data-url'=>route('bill.product'))) }}
                                </td>
...
<script>
    document.addEventListener('DOMContentLoaded', function() {
        ...
        form.addEventListener('submit', function(event) {
            ...
            // Loop through all form elements to apply validation
            ...
            if (form.checkValidity()) {
                form.submit(); // Replace with AJAX call if submitting via JavaScript
            }
        });
