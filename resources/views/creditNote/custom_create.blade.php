...
<div class="form-group col-md-12">
    ...
    <select class="form-control select" required="required" id="invoice" name="invoice" required>
        <option disabled selected>{{__('Select Invoice')}}</option>
...
<div class="products_invoice table-responsive d-flex justify-content-center w-100"></div>

<!-- Hidden input to store the removed products -->
