    ...
    <div class="float-end">
        ...
        @endcan
            ...
            @if($customer['is_enable_login'] == 1)
                <a href="{{ route('customer.login',\Crypt::encrypt($customer['id'])) }}" class="btn btn-sm btn-danger"
                data-bs-toggle="tooltip" title="{{__('disable login')}}">
                    <i class="ti ti-logout text-white text-white"></i>
                </a>
            @else
            <a href="{{ route('customer.login',\Crypt::encrypt($customer['id'])) }}" class="btn btn-sm btn-success"
            data-bs-toggle="tooltip" title="{{__('enable login')}}">
                <i class="ti ti-logout text-white text-white"></i>
            </a>
            @endif
