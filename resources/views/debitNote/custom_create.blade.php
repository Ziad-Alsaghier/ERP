...
<div class="modal-body">
    ...
    <div class="products_bill table-responsive d-flex justify-content-center w-100"></div>
    <div class="accounts_bill table-responsive d-flex justify-content-center w-100"></div>
    <!-- <input type="hidden" id="removedProducts" name="removedProducts">
    <input type="text" id="amount" value="0"> -->
    {{ Form::hidden('product_ids[]', null, ['id' => 'removedProducts']) }}
{{ Form::hidden('account_ids[]', null, ['id' => 'removedAccounts']) }}
