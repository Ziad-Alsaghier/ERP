    ...
    <script>
        ...
        if ($(selector + " .repeater").length) {
            ...
            var $repeater = $(selector + ' .repeater').repeater({
                ...
                show: function () {
                    $(this).slideDown();
                    $(this).find('.chart_account_id').attr('id', 'chart_account_id' + itemCounter);
                    itemCounter++; 
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="col employee">
                                <div class="form-group" id="employee-box">
                                    ...
                                    {{ Form::select('employee_id', $employees,null, array('class' => 'form-control select2','id'=>'employee','data-url'=>route('expense.employee'))) }}
                                </div>
                            ...
                            <div class="col customer d-none">
                                <div class="form-group" id="customer-box">
                                    ...
                                    {{ Form::select('customer_id', $customers,null, array('class' => 'form-control select2','id'=>'customer','data-url'=>route('expense.customer'))) }}
                                </div>
                            ...
                            <div class="col vendor d-none">
                                <div class="form-group" id="vender-box">
                                    ...
                                    {{ Form::select('vender_id', $venders,$Id, array('class' => 'form-control select2','id'=>'vender','data-url'=>route('expense.vender'))) }}
                                </div>
                    ...
                    <div>
                        <table class="table mb-0" data-repeater-list="items" id="sortable-table">
                            ...
                            <tbody class="ui-sortable" data-repeater-item>
                                {{-- Momen Mohsen [2024-8-26 3:26 PM] disabled product for now  --}}
                            {{-- <tr>
                            ...
                            <tr>
                                <td  class="form-group">
                                    <select name="chart_account_id" id="chart_account_id" class="chart_account_id form-control select2" required="required">
                                        <option value="" class="ms-5" selected disabled>{{__(' --- Select Account ---')}}</option>
                                        @foreach ($chart_accounts_type as $type)
                                        <optgroup label="{{ __($type['name']) }}">
                                            @foreach ($chart_accounts as $chartAccount)
                                                @if ($type['id'] == $chartAccount['type'])
                                                    ...
                                                    @include('partials.sub-accounts', ['subAccounts' => $chart_subAccounts, 'parent_id' => $chartAccount['id'], 'level' => 1])
                                                @endif
                                            @endforeach
                                        </optgroup>
                                    @endforeach
