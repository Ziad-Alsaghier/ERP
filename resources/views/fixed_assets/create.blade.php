...
<li class="breadcrumb-item">{{ __('Create Asset') }}</li>
@endsection

@section('content')
<div class="row">
    {{ Form::open(['url' => route('fixed-assets.store'), 'class' => 'w-100 needs-validation', 'novalidate', 'enctype' => 'multipart/form-data']) }}
    <div class="col-12">
                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            {{ Form::select('category', $category, null, ['class' => 'form-control select2', 'placeholder' => __('Choice Category'), 'required' => true]) }}
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            {{ Form::select('measurement_unit', $unit, null, ['class' => 'form-control', 'id' => 'measurement_unit', 'placeholder' => __('Enter Measurement Unit'), 'required' => true]) }}
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            {{ Form::select('tax_percentage', $tax, null, ['class' => 'form-control', 'id' => 'tax_percentage', 'placeholder' => __('Enter Tax Percentage'), 'required' => true]) }}
                            <div class="invalid-feedback">Please enter the measurement unit.</div>
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            {{ Form::text('barcode', '', ['class' => 'form-control', 'placeholder' => __('Enter Barcode')]) }}
                        </div>
                    </div>
                    <div class="col-md-6 form-group">
                        ...
                        <div class="choose-file ">
                            <label for="asset_image" class="form-label">
                                <input type="file" class="form-control" name="asset_image" id="asset_image" data-filename="asset_image_create">
