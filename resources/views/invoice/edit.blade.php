                    ...
                    $.ajax({
                        ...
                        success: function (data) {
                            ...
                            if (invoiceItems != null) {
                                ...
                                $(el.parent().parent().parent().parent().find('.quantity')).val(invoiceItems.quantity);
                                $(el.parent().parent().parent().parent().find('.price')).val(invoiceItems.price);
                                $(el.parent().parent().parent().parent().find('.discount')).val(invoiceItems.discount);
                                $(el.parent().parent().parent().parent().parent().find('.pro_description')).val(invoiceItems.description);
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <div class="form-icon-user">
                                            <textarea class="form-control" name="invoice_details">{{$invoice->invoice_details}}</textarea>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-check form-switch">
                                        <input type="checkbox" class="form-check-input" id="make_project" name="make_project" {{ $invoice->project == 1 ? 'checked' : '' }} />
                        ...
                        <table class="table mb-0 table-custom-style" data-repeater-list="items" id="sortable-table">
                            ...
                            <tr>
                                ...
                                <td width="25%" class="form-group pt-0">
                                    {{ Form::select('item', $product_services,null, array('class' => 'form-control item ','id'=>'item','data-url'=>route('invoice.product'))) }}
