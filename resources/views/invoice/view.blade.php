                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-sm-12 col-md-6 col-lg-5 col-xl-3">
                                                <p>
                                                    ...
                                                    <a class="btn btn-outline-primary" data-bs-toggle="tooltip" title="{{__('Click to copy')}}" data-original-title="{{__('Click to copy')}}" style="direction: ltr" onclick="copyText(this)">{{ AUth::user()->ordersNumberFormat($invoice->order_id) }}</a>
                                                </p>
                                            </div>
                                            @endif
                                            <div class="col-sm-12 col-md-6 col-lg-5 col-xl-3">
                                ...
                                <div class="row">
                                        ...
                                        <small class="font-style">
                                            ...
                                            @else
                                                @if(!empty($customer->billing_name))
                                                    ...
                                                    @if($setting['vat_gst_number_switch'] == 'on')
                                    ...
                                    <div class="col">
                                        <div class="float-end mt-3">
                                            @if (!empty($setting['sellerName']) || !empty($setting['vatRegistrationNumber']))
                                                @php
                                                    echo $qrCode;
                                                @endphp
                                            @else
        ...
        <div class="col-12">
            <div class="card">
                <div class="card-body table-border-style">
                    ...
                    @if ($user_plan->storage_limit <= $invoice_user->storage_limit && $user_plan->storage_limit != -1)
                        <small
