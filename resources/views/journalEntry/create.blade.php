...
@section('breadcrumb')
    ...
    <li class="breadcrumb-item">{{ __('Journal Entry Create') }}</li>
@endsection
    ...
    <script>
        ...
        if ($(selector + " .repeater").length) {
            ...
            var $repeater = $(selector + ' .repeater').repeater({
                ...
                show: function() {
                    $(this).slideDown();
                    $(this).find('#accounts').attr('id', 'accounts' + itemCounter);
                    itemCounter++;
...
@section('content')
    {{ Form::open(['url' => 'journal-entry', 'enctype' => 'multipart/form-data', 'class' => 'w-100']) }}
                ...
                <div class="card-body">
                    <div class="row">
                        ...
                        <div class="col-md-6 form-group">
                            {{ Form::label('attachment', __('Add attachment'), ['class' => 'form-label']) }}
                        ...
                        <table class="table mb-0" data-repeater-list="accounts" id="sortable-table">
                            ...
                            <tbody class="ui-sortable" data-repeater-item>
                                <tr>
                                    ...
                                    <td>
                                        <a href="#" class="ti ti-trash btn p-1 btn-danger text-white"
                            ...
                            <tfoot>
                                <tr>
                                    <td></td>
                                    <td><strong>{{ __('Total Debit') }} ({{ \Auth::user()->currencySymbol() }}) <span
                                                class="totalDebit">0.00</span></strong></td>
                                    <td><strong>{{ __('Total Credit') }} ({{ \Auth::user()->currencySymbol() }}) = <span
                                                class="totalCredit">0.00</span></strong></td>
                                    <td></td>
                                    <td></td>
                                </tr>
                            </tfoot>
