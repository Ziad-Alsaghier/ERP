                                    ...
                                    @if(Gate::check('edit revenue') || Gate::check('delete revenue'))
                                        <td class="action">
                                            <div class="action-btn bg-primary ms-2">
                                                <a href="{{ route('payment.show',$payment->id) }}" class="mx-3 btn btn-sm align-items-center" data-title="{{__('Show Payment')}}" data-size="lg" data-bs-toggle="tooltip" title="{{__('Show')}}" data-original-title="{{__('Show')}}">
