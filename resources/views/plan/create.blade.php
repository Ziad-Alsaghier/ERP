...
<div class="modal-body">
    ...
    <div class="row">
        ...
        <hr>
        <h3 class="mb-4">{{ __('Pricing') }}</h3>
        <div class="form-group col-md-6">
            {{ Form::label('user_price', __('User Price'), ['class' => 'form-label']) }}
            {{ Form::number('user_price', null, ['class' => 'form-control']) }}
            <span class="small">{{ __('For 1 User') }}</span>
        </div>
        <div class="form-group col-md-6">
            {{ Form::label('customers_price', __('Customers Price'), ['class' => 'form-label']) }}
            {{ Form::number('customers_price', null, ['class' => 'form-control']) }}
            <span class="small">{{ __('For 1000 Customers') }}</span>
        </div>
        <div class="form-group col-md-6">
            {{ Form::label('storage_price', __('Storage Price'), ['class' => 'form-label']) }}
            {{ Form::number('storage_price', null, ['class' => 'form-control']) }}
            <span class="small">{{ __('For 1GB') }}</span>
        </div>
        <div class="form-group col-md-6">
            {{ Form::label('venders_price', __('Venders Price'), ['class' => 'form-label']) }}
            {{ Form::number('venders_price', null, ['class' => 'form-control']) }}
            <span class="small">{{ __('For 1000 Venders') }}</span>
        </div>
        <div class="form-group col-md-6">
            {{ Form::label('clients_price', __('Clients Price'), ['class' => 'form-label']) }}
            {{ Form::number('clients_price', null, ['class' => 'form-control']) }}
            <span class="small">{{ __('For 1000 Clients') }}</span>
        </div>
    </div>
    ...
    <div class="row">
        <div class="col-md-5">
            ...
            <div class="form-group">
                ...
                <div class="form-check form-switch custom-switch-v1 float-start">
    ...
    <div class="row">
        ...
        <div class="form-group col-md-3">
            <div class="form-check form-switch ">
                <input type="checkbox" class="form-check-input" name="enable_manufacturing" id="enable_manufacturing" checked>
                <label class="custom-control-label form-label"
                    for="enable_manufacturing">{{ __('Manufacturing') }}</label>
            </div>
        </div>
        <div class="form-group col-md-3">
            <div class="form-check form-switch ">
    ...
    <div class="row">
        <div class="form-group col-md-3 mt-2">
            <div class="form-check form-switch">
                ...
                <label class="custom-control-label form-label" for="active">{{ __('Active') }}</label>
            </div>
        </div>
        <div class="form-group col-md-3 mt-2">
            <div class="form-check form-switch">
                <input type="checkbox" class="form-check-input" name="visible" id="visible" checked>
                <label class="custom-control-label form-label" for="visible">{{ __('visible') }}</label>
            </div>
        </div>
    </div>
