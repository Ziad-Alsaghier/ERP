                ...
                <div class="card-body">
                    <ul class="nav nav-tabs pt-3" id="myTab" role="tablist">
                        <li class="nav-item" role="presentation">
                            <button class="nav-link text-dark active" id="year-tab" data-bs-toggle="tab"
                                data-bs-target="#yearly_pane" type="button" role="tab" aria-controls="yearly_pane"
                                aria-selected="true">{{ __('Per Year') }}</button>
                        </li>
                        <li class="nav-item" role="presentation">
                            <button class="nav-link text-dark" id="month-tab" data-bs-toggle="tab"
                                data-bs-target="#month-tap-pane" type="button" role="tab"
                                aria-controls="month-tap-pane" aria-selected="false">{{ __('Per Month') }}</button>
                        </li>
                        <li class="nav-item" role="presentation">
                            <button class="nav-link text-dark" id="lifetime-tab" data-bs-toggle="tab"
                                data-bs-target="#lifetime-tap-pane" type="button" role="tab"
                                aria-controls="lifetime-tap-pane" aria-selected="false">{{ __('One Time') }}</button>
                        </li>
                    ...
                    <div class="tab-content" id="myTabContent">
                        ...
                        <div class="tab-pane fade show active" id="yearly_pane" role="tabpanel" aria-labelledby="year-tab"
                            tabindex="0">
                            <div class="row">
                                @foreach ($plans as $plan)
                                    @if (
                                        ($plan->duration == 'year' && \Auth::user()->type == 'super admin') ||
                                            ($plan->duration == 'year-ex' && \Auth::user()->type == 'super admin'))
                                        <div class="plan_card">
                        ...
                        ">
                                                <div class="card-body">
                                                    ...
                                                    @if ($plan->trial_days > 0)
                                                        <p class="mb-0">
                                                            <span
                                                                class="badge text-bg-success">{{ __('Free Trial Days : ') . __($plan->trial_days ? $plan->trial_days : 0) }}</span><br />
                                                        </p>
                                                    @endif
                                                    @if (\Auth::user()->type == 'super admin')
                                                        <p>
                                                            {{ 'id = ' . $plan->id . ' with count Users = ' . $plan->countusers }}
                                                        </p>
                                                    @endif
                                                    @if (\Auth::user()->type == 'super admin')
                                                        <div class="d-flex">
                                                            <div class="me-1">{{ __('Active') }}</div>
                                                            <div class="form-check form-switch custom-switch-v1 float-end">
                                                                <input type="checkbox" name="plan_disable"
                                                                    class="form-check-input input-primary is_disable"
                                                                    value="1" data-id='{{ $plan->id }}'
                                                                    data-name="{{ __('plan') }}"
                                                        ...
                                                        <div class="d-flex ">
                                                            <div class="me-1">{{ __('visible') }}</div>
                                                            <div class="form-check form-switch custom-switch-v1 float-end">
                                                                <input type="checkbox" name="plan_visible"
                                                                    class="form-check-input input-primary is_visible"
                                                                    value="1" data-id='{{ $plan->id }}'
                                                                    data-name="{{ __('plan') }}"
                                                                    {{ $plan->is_visible == 1 ? 'checked' : '' }}>
                                                                <label class="form-check-label" for="plan_visible"></label>
                                                            </div>
                                                        </div>
                                                    @endif
                                                    <div class="row ">
                                                        ...
                                                        <div class="col-6">
                                                            <ul class="list-unstyled">
                                                                ...
                                                                <li><span class="theme-avtar"><i
                                                                            class="text-primary ti ti-circle-plus"></i></span>{{ $plan->manfuc == 1 ? __('Enable') : __('Disable') }}
                                                                    {{ __('Manufacturing') }}
                                                                </li>
                                                                <li><span class="theme-avtar"><i
                                                        ...
                                                        <div class="row align-items-center">
                                                            ...
                                                            <div class="col-2 me-3">
                                                                <a title="{{ __('Edit Plan') }}" href="#"
                                                                    ...
                                                                    data-title="{{ __('Edit Plan') }}" data-size="lg"
                                                                    data-toggle="tooltip"
                                                        ...
                                                        @if (
                                                            ...
                                                            @if (\Auth::user()->type != 'super admin')
                                                                ...
                                                                @if ($plan->id != \Auth::user()->plan)
                                                                    @if ($plan->price > 0)
                                                                        <a href="{{ route('checkout', \Illuminate\Support\Facades\Crypt::encrypt($plan->id)) }}"
                                                                ...
                                                                @if ($plan->id != 1 && $plan->id != \Auth::user()->plan)
                                                                    @if (\Auth::user()->requested_plan != $plan->id)
                                                                        <a href="{{ route('send.request', [\Illuminate\Support\Facades\Crypt::encrypt($plan->id)]) }}"
                                                                            class="btn btn-lg btn-secondary btn-icon m-1"
                                    ...
                                    @elseif ($plan->duration == 'year' && \Auth::user()->type !== 'super admin' && $plan->is_visible == 1)
                                        <div class="plan_card">
                    ...
                    ">
                                                <div class="card-body">
                                                    ...
                                                    @if ($plan->trial_days > 0)
                                                        <p class="mb-0">
                                                            <span
                                                                class="badge text-bg-success">{{ __('Free Trial Days : ') . __($plan->trial_days ? $plan->trial_days : 0) }}</span>
                                                            <br />
                                                        </p>
                                                    @endif
                                                    @if (\Auth::user()->type == 'super admin')
                        ...
                        <div class="tab-pane fade" id="month-tap-pane" role="tabpanel" aria-labelledby="month-tab"
                            tabindex="0">
                            ...
                            <div class="row">
                                ...
                                @foreach ($plans as $plan)
                                    @if (
                                        ($plan->duration == 'month' && \Auth::user()->type == 'super admin') ||
                                            ($plan->duration == 'month-ex' && \Auth::user()->type == 'super admin'))
                                        <div class="plan_card">
                                            <div class="card price-card price-1 wow animate__fadeInUp"
                                                data-wow-delay="0.2s"
                                                style="
                        ...
                        ">
                                    ...
                                    @elseif ($plan->duration == 'month' && \Auth::user()->type !== 'super admin' && $plan->is_visible == 1)
                                        <div class="plan_card">
                                            <div class="card price-card price-1 wow animate__fadeInUp"
                                                data-wow-delay="0.2s"
                                                style="
                        ...
                        <div class="tab-pane fade" id="lifetime-tap-pane" role="tabpanel" aria-labelledby="lifetime-tab"
                            tabindex="0">
                            <div class="row">
                                {{-- @dd($plans) --}}
                                @foreach ($plans as $plan)
                                    @if (
                                        ($plan->duration == 'lifetime' && \Auth::user()->type == 'super admin') ||
                                            ($plan->duration == 'one time' && \Auth::user()->type == 'super admin'))
                                        <div class="plan_card">
                                            <div class="card price-card price-1 wow animate__fadeInUp"
                                                data-wow-delay="0.2s"
                                                style="
                        ...
                        ">
                                                <div class="card-body">
                                                    <span class="price-badge bg-primary">{{ $plan->name }}
                                    ...
                                    @elseif (
                                        ($plan->duration == 'lifetime' && \Auth::user()->type !== 'super admin' && $plan->is_visible == 1) ||
                                            ($plan->duration == 'one time' && \Auth::user()->type !== 'super admin' && $plan->is_visible == 1))
                                        <div class="plan_card">
                                            <div class="card price-card price-1 wow animate__fadeInUp"
                                                data-wow-delay="0.2s"
                                                style="
                        ...
                        ">
                                                <div class="card-body">
                                                    ...
                                                    <h1 class="mb-4 f-w-600 ">
                                                        {{ isset($admin_payment_setting['currency_symbol']) ? $admin_payment_setting['currency_symbol'] : '$' }}{{ number_format($plan->price) }}
                                                        <small class="text-sm">/{{ __('One Time') }}</small>
                                                    </h1>
                                                    @if ($plan->trial_days > 0)
                                                        <p class="mb-0">
                                                            <span
...
@push('script-page')
    ...
    <script>
        ...
        $(document).on("click", ".is_visible", function() {

            var id = $(this).attr('data-id');
            var is_visible = ($(this).is(':checked')) ? $(this).val() : 0;

            $.ajax({
                url: '{{ route('plan.visible') }}',
                type: 'POST',
                data: {
