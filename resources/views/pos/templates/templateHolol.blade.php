            ...
            <div class="row">
                <div class="col-2">
                    ...
                    @else
                            ...
                            route('purchase.link.copy', \Crypt::encrypt($pos->purchase_id)),
                            'QRCODE',
                            1.5,
                            1.5,
                        ) !!}
                ...
                <div class="col-3">
                    <div class="title-of-invoce_con">
                        <p class="title-of-invoce">{{__("POS Invoice", [], 'ar')}}  <br> {{ __('POS Invoice',[],'en')}}</p>
                    </div>
                </div>
                <div class="col-2">
            ...
            <div class="row">
                ...
                <div class="col-6 information" style="height: 77px">
                    <table class="table table-borderd">
                        ...
                        @if (isset($pos->order_id))
                            <tr>
                                <td>REF. No.:</td>
                                <td>{{ App\Models\Utility::ordersNumberFormat($pos->order_id) }}</td>
                                <td>الرقم المرجعي</td>
                            </tr>
                        @endif
                        <tr>
                            <td>User</td>
                            <td>{{ $pos->user_id != null ? $pos->user->name : '-' }}</td>
                            <td>المستخدم</td>
                        </tr>
                        <tr>
                            <td>bracnh</td>
                            <td>{{ App\Models\Employee::where('user_id', $pos->user_id)->first()->branch->name ?? '-' }}
                            </td>
                            <td>الفرع</td>
                        </tr>
                    </table>
