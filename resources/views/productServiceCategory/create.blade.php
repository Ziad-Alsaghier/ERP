{{ Form::open(array('url' => 'product-category', 'enctype'=>"multipart/form-data")) }}
<div class="modal-body">
    <div class="row">
        ...
        <div class="form-group col-md-12 d-block">
            {{ Form::label('parent', __('Parent Category'),['class'=>'form-label']) }}
            {{ Form::select('parent_id',$parents,null, array('class' => 'form-control select catparent ')) }}
        </div>
        ...
        <div class="form-group col-md-12">
            ...
            <div class="form-group col-md-12">
            {{ Form::label('Image', __('Category Image'), ['class' => 'form-label']) }}
            {{ Form::file('image', ['class' => 'form-control ', 'required' => 'required']) }}
            <small>{{ __('For Category Image') }}</small>
        </div>
