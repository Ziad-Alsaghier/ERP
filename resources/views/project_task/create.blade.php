    ...
    <div class="row">
        ...
        <div class="col-6">
            <div class="form-group">
                ...
                {{ Form::number('estimated_hrs', 3, ['class' => 'form-control','required' => 'required','min'=>'0','maxlength' => '8']) }}
            </div>
        </div>
        <div class="col-6">
            <div class="form-group">
        ...
        <div class="col-6">
            <div class="form-group">
                ...
                {{ Form::date('end_date',  \Carbon\Carbon::now()->addDays(3)->format('Y-m-d'), ['class' => 'form-control']) }}
            </div>
        </div>
    </div>
