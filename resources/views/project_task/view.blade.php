    ...
    <div class="card">
        <div class="card-body">
            ...
            @foreach ($customFields as $field)
                @foreach ($customFields_label as $label)
                @if ($label->id == $field->field_id )
                    <div class="col text-md-right">
                        <hr>
                            <strong class="text-danger">{{ $label->name }} :</strong><br>
                            <strong>{{ $field->value }}</strong><br>
                        <br>
                    </div>
                    @endif
                @endforeach
                ...
                <form id="add_file" class="collapse pb-2">
                    <div class="card border shadow-none">
                        <div class="px-3 py-2 row align-items-center">
                            ...
                            <img id="blah" src="{{asset(Storage::url('uploads/avatar/'.'default.png'))}}" class="img_preview" />
                        </div>
                    </div>
                </form>
                        ...
                        <div class="row align-items-center">
                            <div class="col-auto">
                                <a href="#" class="avatar avatar-sm rounded-circle ms-2">
                                    ...
                                    @if(isset($user->avatar)) src="{{asset('/storage/uploads/avatar/'.$user->avatar)}}" @else src="{{asset('/storage/uploads/avatar/avatar.png')}}" @endif
