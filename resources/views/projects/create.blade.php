    ...
    <div class="row">
        ...
        <div class="col-sm-6 col-md-6">
            <div class="form-group">
                ...
                {!! Form::select('client', $clients, null,array('class' => 'form-control select2','id'=>'client','required'=>'required')) !!}
            </div>
        </div>
        <div class="col-sm-6 col-md-6">
            <div class="form-group">
                {{ Form::label('user', __('User'),['class'=>'form-label']) }}<span class="text-danger">*</span>
                {!! Form::select('user[]', $users, null,array('class' => 'form-control select2','id'=>'users','required'=>'required')) !!}
            </div>
        </div>
        <div class="col-sm-6 col-md-6">
            <div class="form-group">
    ...
    <div class="row">
        <div class="col-sm-12 col-md-12">
            <div class="form-group">
                ...
                {{ Form::text('tag', null, ['class' => 'form-control select2', 'data-toggle' => 'tags' ,'multiple']) }}
            </div>
        </div>
    </div>
    <div class="row">
