                            ...
                            <tr>
                                <td>
                                    <div class="d-flex align-items-center">
                                        ...
                                        {{-- @if ($project->ref == 'proposal')
                                        <a href="{{ route('proposal.show',\Crypt::encrypt($project->ref_id)) }}" class="btn btn-outline-primary">{{ AUth::user()->proposalNumberFormat($project->project_name) }}
                                        </a>
                                        @else
                                        <p class="mb-0">{{ $project->project_name }}</p>
                                        @endif --}}
                                        <a href="{{ route('projects.show',$project) }}" class="btn btn-outline-primary" style="direction: ltr;">{{ AUth::user()->projectNumberFormat($project->id) }}</a>
                                    </div>
                                </td>
                                <td class="">
                                ...
                                <td class="text-end">
                                    <span>
                                        ...
                                        <div class="btn btn-primary btn-sm ">
                                            <a href="{{ route('proposal.show',\Crypt::encrypt($project->ref_id)) }}" class="btn d-inline-flex p-0 text-white"  data-size="lg" data-bs-toggle="tooltip" title="{{__('Proposal Detail')}}" data-title="{{__('Proposal Detail')}}">
                                                {{ __('Proposal Detail') }}
                                        ...
                                        <div class="action-btn bg-secondary ms-2">
                                            <a href="#" class="mx-3 btn btn-sm d-inline-flex align-items-center" data-url="{{ route('project.copy', [$project->id]) }}" data-ajax-popup="true" data-size="lg" data-bs-toggle="tooltip" title="{{__('Duplicate')}}" data-title="{{__('Duplicate Project')}}">
