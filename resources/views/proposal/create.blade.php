...
@section('content')
    <div class="row">
        {{ Form::open(array('url' => 'proposal','id'=>'proposal','class'=>'w-100 needs-validation','novalidate')) }}
        <div class="col-12">
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group" id="customer-box">
                                ...
                                {{ Form::select('customer_id', $customers,$customerId, array('class' => 'form-control select2','id'=>'customer','data-url'=>route('proposal.customer'),'required')) }}
                            </div>
                        ...
                        <div class="col-md-6">
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        {{ Form::label('proposal_details', __('Proposal Details'),['class'=>'form-label','required']) }}
                                        <div class="form-icon-user">
                                            <textarea class="form-control" name="proposal_details"></textarea>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-6">
                        ...
                        <table class="table mb-0" data-repeater-list="items">
                            ...
                            <tr>
                                <td width="25%" class="form-group pt-0">
                                    {{ Form::select('item', $product_services,'', array('class' => 'form-control item select2','id'=>'item'  ,'data-url'=>route('proposal.product'),'required'=>'required')) }}
                                </td>
                                <td>
