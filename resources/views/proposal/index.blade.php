...
@section('breadcrumb')
    ...
    <li class="breadcrumb-item">{{__('Manage Proposals')}}</li>
@endsection
...
@section('action-btn')
    <div class="float-end">
        ...
        @can('create proposal')
            <a href="{{ route('proposal.create') }}" class="btn btn-sm btn-primary" data-bs-toggle="tooltip" title="{{__('Create')}}">
                        ...
                        <div class="d-flex align-items-center justify-content-end">
                            ...
                            <div class="col-xl-3 col-lg-3 col-md-6 col-sm-12 col-12 mr-2">
                                <div class="btn-box">
                                    ...
                                    {{ Form::select('customer', $customer, isset($_GET['customer']) ? $_GET['customer'] : '', ['class' => 'form-control select2','id'=>'customer']) }}
                                </div>
                            </div>
                            <div class="col-xl-3 col-lg-3 col-md-6 col-sm-12 col-12">
                                <div class="btn-box">
                                    {{ Form::label('status', __('Status'),['class'=>'form-label'])}}
                                    {{ Form::select('status', [''=>'Select Status'] + $status,isset($_GET['status'])?$_GET['status']:'', array('class' => 'form-control select2','id'=>'status')) }}
                                </div>
                            </div>
            ...
            <div class="card">
                <div class="card-body table-border-style">
                    <div class="table-responsive">
                        <table class="table datatable" id="proposal_table">
                            <thead>
                            <tr>
                                <th> {{__('Proposal')}}</th>
                                <th> {{__('By User')}}</th>
                            ...
                            @foreach ($proposals as $proposal)
                                <tr class="font-style">
                                    ...
                                    <td>
                                        ...
                                        <p class="btn btn-outline-primary" style="direction: ltr">{{ AUth::user()->ordersNumberFormat($proposal->order_id) }}</p>
                                        @endif
                                    </td>
