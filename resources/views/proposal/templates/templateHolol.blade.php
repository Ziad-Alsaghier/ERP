    ...
    <div class="invoice-box">
        <div class="container">
            ...
            <div class="row">
                <div class="col-2">
                    ...
                    @else
                            ...
                            route('proposal.link.copy', \Crypt::encrypt($proposal->proposal_id)),
                            'QRCODE',
                            1.5,
                            1.5,
                        ) !!}
                ...
                <div class="col-3">
                    <div class="title-of-invoce_con">
                        <p class="title-of-invoce">عرض سعر مبيعات<br>Proposal</p>
                    </div>
                </div>
                <div class="col-2">
            ...
            <div class="row">
                ...
                <div class="col-6 information" style="height: 77px">
                    <table class="table table-borderd">
                        ...
                        @if (isset($proposal->order_id))
                            <tr>
                                <td>REF. No.:</td>
                                <td>{{ App\Models\Utility::ordersNumberFormat($proposal->order_id) }}</td>
                                <td>الرقم المرجعي</td>
                            </tr>
                        @endif
                        <tr>
                            <td>User</td>
                            <td>{{ $proposal->user_id != null ? $proposal->user->name : '-' }}</td>
                            <td>المستخدم</td>
                        </tr>
                        <tr>
                            <td>bracnh</td>
                            <td>{{ App\Models\Employee::where('user_id', $proposal->user_id)->first()->branch->name ?? '-' }}
                            </td>
                            <td>الفرع</td>
                        </tr>
                    </table>
                                                    ...
                                                    @foreach ($orders->itemData as $key => $iteam)
                                                                                                        ...
                                                                                                        <tr>
                                                                                                            ...
                                                                                                            <td>
                                                                                                                ...
                                                                                                                @if ($key_dd == 'التسعيرة النهائية')
                                                                                                                    @foreach ($value as $ke => $val)
                                                                                                                        @if ($ke == 'سعر الافرادي')
                                                                                                                            {{\App\Models\Utility::priceFormat($settings_data,$val,3) }}
                                                                                                                        @endif
                                                                                                                    @endforeach
                                                                                                                @endif
                                                                                                                @endforeach
                                                                                                            ...
                                                                                                            <td class="text-end">
                                                                                                                {{ \App\Models\Utility::priceFormat($settings_data,$total_with_tax) }}
                                                                                                            </td>
                                                                                                        </tr>
                                                                                     @php
                                                                                ...
                                                                                @else
                                                                                                        ...
                                                                                                        <tr>
                                                                                                            ...
                                                                                                            <td>{{\App\Models\Utility::priceFormat($settings_data,$iteam->price) }}</td>
                                                                                                                                                ...
                                                                                                                                                @php
                                                                                                                                                    ...
                                                                                                                                                    if (!empty($iteam->tax)) {
                                                                                                                                                        foreach (explode(',', $iteam->tax) as $tax) {
                                                                                                                                                            ...
                                                                                                                                                            $itemTax['rate'] =
                                                                                                                                                                $getTaxData[$tax]['rate'] . '';
                                                                                                                                                            $itemTax['price'] = \App\Models\Utility::priceFormat($settings_data,
                                                                                                                                                                $taxPrice,
                                                                                                                                                            );
                                                                                                            ...
                                                                                                            <td class="text-end">
                                                                                                                {{\App\Models\Utility::priceFormat($settings_data,$iteam->price * $iteam->quantity + $totalTaxPrice) }}
                                                                                                            </td>
                                                                                                        </tr>
                                                                                                        @php
                                                                                                            // $subtotal += $totalTaxPrice;
                ...
                <tfoot>
                    <tr class="item">
                        <td colspan="9"><span class="left" style="float: left; padding-left:5px;">Net Amount</span>
                            <span class="central-text"> {{ \App\Models\Utility::priceFormat($settings_data, $total_product) }} </span>
                    ...
                    <tr class="item">
                        <td colspan="9"><span class="left" style="float: left; padding-left:5px;">Vat Total</span>
                            ...
                            @endphp
                            <span class="central-text">{{\App\Models\Utility::priceFormat($settings_data, $vat_total) }} </span> <span class="right"
                    ...
                    <tr class="item">
                        <td colspan="9"><span class="left" style="float: left; padding-left:5px;">Total</span>
                            ...
                            {{ \App\Models\Utility::priceFormat($settings_data,$finaltotal) }}
            ...
            <div class="termsandcond" style="direction: rtl">
                @if (isset($settings['proposal_footer']))
                    {!! $settings['proposal_footer'] !!}
                @endif
            </div>
