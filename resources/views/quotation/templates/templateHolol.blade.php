            ...
            <div class="row">
                <div class="col-2">
                    ...
                    @else
                            ...
                            route('purchase.link.copy', \Crypt::encrypt($quotation->purchase_id)),
                            'QRCODE',
                            1.5,
                            1.5,
                        ) !!}
                ...
                <div class="col-6 information" style="height: 77px">
                    <table class="table table-borderd">
                        ...
                        @if (isset($quotation->order_id))
                            <tr>
                                <td>REF. No.:</td>
                                <td>{{ App\Models\Utility::ordersNumberFormat($quotation->order_id) }}</td>
                                <td>الرقم المرجعي</td>
                            </tr>
                        @endif
                        <tr>
                            <td>User</td>
                            <td>{{ $quotation->user_id != null ? $quotation->user->name : '-' }}</td>
                            <td>المستخدم</td>
                        </tr>
                        <tr>
                            <td>bracnh</td>
                            <td>{{ App\Models\Employee::where('user_id', $quotation->user_id)->first()->branch->name ?? '-' }}
                            </td>
                            <td>الفرع</td>
                        </tr>
                    </table>
