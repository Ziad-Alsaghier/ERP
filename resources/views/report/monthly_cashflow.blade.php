                            ...
                            <div class="row justify-content-between">
                                <div class="col-xl-3">
                                    <ul class="nav nav-pills my-3" id="pills-tab" role="tablist">
                                        ...
                                        <li class="nav-item">
                                            <a class="nav-link" id="pills-profile-tab" data-bs-toggle="pill"
                                               href="{{ route('report.date.cashflow') }}"
                                               onclick="window.location.href = '{{ route('report.date.cashflow') }}'" role="tab"
                                               aria-controls="pills-profile" aria-selected="false">{{ __('By Date') }}</a>
                                        </li>
                                    </ul>
                                </div>
                                <div class="col-xl-9">
