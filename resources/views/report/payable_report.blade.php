                        ...
                        <div class="col-sm-12">
                            <div class="tab-content" id="myTabContent2">
                                <div class="tab-pane fade fade show active" id="vendor_balance" role="tabpanel"
                                    ...
                                    <table class="table pc-dt-simple datatable" id="report-vendor-balance">
                                        <thead>
                                            <tr>
                                ...
                                <div class="tab-pane fade fade show" id="payable_summary" role="tabpanel"
                                    ...
                                    <table class="table pc-dt-simple datatable" id="report-payable-summary">
                                        <thead>
                                            <tr>
                                ...
                                <div class="tab-pane fade fade show" id="payable_details" role="tabpanel"
                                    ...
                                    <table class="table pc-dt-simple datatable" id="report-payable-details">
                                        <thead>
                                            <tr>
                                                <th>{{ __('Vendor Name') }}</th>
                                                <th>{{ __('Date') }}</th>
