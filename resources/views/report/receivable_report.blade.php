                        ...
                        <div class="col-sm-12">
                            <div class="tab-content" id="myTabContent2">
                                <div class="tab-pane fade fade show active" id="customer_balance" role="tabpanel"
                                    ...
                                    <table class="table pc-dt-simple datatable" id="report-customer-balance">
                                        <thead>
                                            <tr>
                                ...
                                <div class="tab-pane fade fade show" id="receivable_summary" role="tabpanel"
                                    ...
                                    <div class="table-responsive">
                                    <table class="table pc-dt-simple datatable" id="report-receivable-summary">
                                        <thead>
                                            <tr>
                                ...
                                <div class="tab-pane fade fade show" id="receivable_details" role="tabpanel"
                                    ...
                                    <table class="table pc-dt-simple datatable" id="report-receivable-details">
                                        <thead>
                                            <tr>
                                                <th>{{ __('Customer Name') }}</th>
                                                <th>{{ __('Date') }}</th>
                                ...
                                <div class="tab-pane fade fade show" id="aging_summary" role="tabpanel"
                                    ...
                                    <table class="table pc-dt-simple datatable" id="report-aging-summary">
                                        <thead>
                                            <tr>
                                                <th>{{ __('Customer Name') }}</th>
                                                <th>{{ __('Current') }}</th>
                                ...
                                <div class="tab-pane fade fade show" id="aging_details" role="tabpanel"
                                    ...
                                    <table class="table pc-dt-simple datatable" id="report-aging-details">
                                        <thead>
                                            <tr>
                                                <th>{{ __('Date') }}</th>
                                                <th>{{ __('Transaction') }}</th>
