...
@section('breadcrumb')
    ...
    <li class="breadcrumb-item">{{__('Account Summary')}}</li>
@endsection
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-xl-3 col-lg-3 col-md-6 col-sm-12 col-12">
                                        <div class="btn-box">
                                            ...
                                            {{ Form::select('type',$types,isset($_GET['type'])?$_GET['type']:'', array('class' => 'form-control select','placeholder'=>__('Select account type'))) }}
                                        </div>
                                    </div>
