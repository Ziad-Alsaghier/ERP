...
<div class="modal-body">
    <div class="row">
        ...
        <div class="form-group  col-md-6">
            ...
            {{ Form::select('customer_id', $customers,null, array('class' => 'form-control select2', 'id'=>'customer_id','required'=>'required')) }}
        </div>
        ...
        <div class="form-group  col-md-6">
            ...
            {{ Form::select('category_id', $categories,null, array('class' => 'form-control select2','id'=>'category_id','required'=>'required')) }}
        </div>
