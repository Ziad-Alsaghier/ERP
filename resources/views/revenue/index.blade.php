                            ...
                            <div class="col-xl-10">
                                <div class="row">
                                    ...
                                    <div class="col-3">
                                        ...
                                        {{ Form::date('date', isset($_GET['date'])?$_GET['date']:null, array('class' => 'form-control month-btn','id'=>'pc-daterangepicker-1')) }}
                                    ...
                                    <div class="col-xl-3 col-lg-3 col-md-6 col-sm-12 col-12 month">
                                        <div class="btn-box">
                                            ...
                                            {{ Form::select('account',$account,isset($_GET['account'])?$_GET['account']:'', array('class' => 'form-control select2','id'=>'account')) }}
                                        </div>
                                    </div>
                                    <div class="col-xl-3 col-lg-3 col-md-6 col-sm-12 col-12 date">
                                        <div class="btn-box">
                                            {{ Form::label('customer', __('Customer'),['class'=>'form-label'])}}
                                            {{ Form::select('customer',$customer,isset($_GET['customer'])?$_GET['customer']:'', array('class' => 'form-control select2','id'=>'customer')) }}
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-xl-3 col-lg-3 col-md-6 col-sm-12 col-12">
                                        <div class="btn-box">
                                            ...
                                            {{ Form::select('category',$category,isset($_GET['category'])?$_GET['category']:'', array('class' => 'form-control select2','id'=>'category')) }}
                                        </div>
                                    </div>
                        ...
                        <table class="table datatable">
                            ...
                            @foreach ($revenues as $revenue)
                                ...
                                <tr class="font-style">
                                    ...
                                    <td>{{  (!empty($revenue['bank_account'])?$revenue['bank_account']['bank_name'].' '.$revenue['bank_account']['holder_name']:'-') }}</td>
                                    ...
                                    <td class="Action">
                                            ...
                                            <span>
                                                <div class="action-btn bg-primary ms-2">
                                                    <a href="{{ route('revenue.show',$revenue['id']) }}" class="mx-3 btn btn-sm align-items-center"  data-bs-toggle="tooltip" title="{{__('show')}}" title="{{__('show')}}" data-original-title="{{__('show')}}">
                                            ...
                                            @elseif (isset($revenue['invoice_id']))
                                            <div class="Id">
                                                <a href="{{ route('invoice.show', \Crypt::encrypt($revenue['invoice_id'])) }}" class="btn btn-outline-primary">{{ AUth::user()->invoiceNumberFormat($revenue['invoice_id']) }}</a>
                                            </div>
                                            @endif
                                        </td>
