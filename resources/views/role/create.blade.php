    ...
    <div class="row">
        <div class="col-lg-12 col-md-12 col-sm-12">
            <div class="form-group">
                ...
                {{Form::text('name',null,array('class'=>'form-control','placeholder'=>__('Enter Role Name'),'required'=>''))}}
                @error('name')
            ...
            <div class="tab-content" id="pills-tabContent">
                        ...
                        <div class="form-group">
                            @if(!empty($permissions))
                                ...
                                <table class="table table-striped mb-0" id="dataTable-1">
                                    ...
                                    @foreach($modules as $module)
                                        <tr>
                                            <td><input type="checkbox" class="form-check-input align-middle ischeck hrm_checkall"  data-id="{{str_replace(' ', '', $module)}}" {{ $module =='hrm dashboard'?'checked':'' }} ></td>
                                            ...
                                            <td>
                                                <div class="row ">
                                                    ...
                                                    @if(in_array('show '.$module,(array) $permissions))
                                                        @if($key = array_search('show '.$module,$permissions))
                                                            <div class="col-md-3 custom-control custom-checkbox">
                                                                {{Form::checkbox('permissions[]',$key,false, ['class'=>'form-check-input isscheck hrm_checkall isscheck_'.str_replace(' ', '', $module),'id' =>'permission'.$key ,  $module == 'hrm dashboard'?'checked':'' ])}}
                                                                {{Form::label('permission'.$key,'Show',['class'=>'custom-control-label'])}}<br>
                                                            </div>
                                                        @endif
                                                    @endif
                ...
                <div class="tab-pane fade" id="pos" role="tabpanel" aria-labelledby="pills-contact-tab">
                    @php
                        $modules=['warehouse','quotation','purchase','pos','barcode','Manufacturing','order'];
                    @endphp
                    <div class="col-md-12">
                        <div class="form-group">
                            @if(!empty($permissions))
