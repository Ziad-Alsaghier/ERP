...
<script>
    $(document).on("change", "select[name='invoice_template'], input[name='invoice_color']", function () {
        ...
        document.getElementById('quotation_logo').onchange = function () {
            var src = URL.createObjectURL(this.files[0])
            document.getElementById('quotation_image').src = src
        }
    ...
    <div class="card">
        <div class="card-body">
            ...
            <ul class="nav nav-pills mb-3" id="pills-tab" role="tablist">
                {{-- pills proposal --}}
                <li class="nav-item">
                    <a class="nav-link active" id="pills-proposal-tab" data-bs-toggle="pill" href="#pills-proposal" role="tab" aria-controls="pills-proposal" aria-selected="true">{{ __('Proposal')}}</a>
                </li>
                {{-- pills invoice --}}
                <li class="nav-item">
                    <a class="nav-link" id="pills-invoice-tab" data-bs-toggle="pill" href="#pills-invoice" role="tab" aria-controls="pills-invoice" aria-selected="false">{{ __('Invoice') }}</a>
                </li>
                {{-- pills bill --}}
                <li class="nav-item">
                    <a class="nav-link" id="pills-bill-tab" data-bs-toggle="pill" href="#pills-bill" role="tab" aria-controls="pills-bill" aria-selected="false">{{ __('Bill') }}</a>
                </li>
                {{-- pills purchase --}}
                <li class="nav-item">
                    <a class="nav-link active" id="pills-purchase-tab" data-bs-toggle="pill" href="#pills-purchase" role="tab" aria-controls="pills-purchase" aria-selected="false">{{ __('Purchase Order')}}</a>
                </li>
                {{-- pills quotation --}}
                <li class="nav-item">
                    <a class="nav-link" id="pills-quotation-tab" data-bs-toggle="pill" href="#pills-quotation" role="tab" aria-controls="pills-pos" aria-selected="false">{{ __('Purchases Quotation')}}</a>
                </li>
                {{-- pills pos --}}
                <li class="nav-item">
                    <a class="nav-link" id="pills-pos-tab" data-bs-toggle="pill" href="#pills-pos" role="tab" aria-controls="pills-pos" aria-selected="false">{{ __('POS Invoice') }}</a>
                </li>
            </ul>
                                    ...
                                    <form id="setting-form" method="post"
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select class="form-control select2" name="proposal_template">
                                                @foreach(App\Models\Utility::templateData()['templates'] as $key =>
                                                $template)
                                                <option value="{{$key}}" {{(isset($settings['proposal_template']) &&
                                                    $settings['proposal_template']==$key) ? 'selected' : '' }}>
                                                    {{$template}}</option>
                                                @endforeach
                                            </select>
                                        </div>
                                                ...
                                                <div class="col-auto">
                                                    <label class="colorinput">
                                                        <input name="proposal_color" type="radio" value="{{$color}}"
                                                            ...
                                                            {{(isset($settings['proposal_color']) &&
                                                            $settings['proposal_color']==$color) ? 'checked' : '' }}>
                                    ...
                                    <form id="setting-form" method="post" action="{{route('template.setting')}}"
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select class="form-control select2" name="invoice_template">
                                                ...
                                                <option value="{{$key}}" {{(isset($settings['invoice_template']) &&
                                                    $settings['invoice_template']==$key) ? 'selected' : '' }}>
                                                    {{$template}}</option>
                                                @endforeach
                                            </select>
                                        </div>
                                                ...
                                                <div class="col-auto">
                                                    <label class="colorinput">
                                                        <input name="invoice_color" type="radio" value="{{$color}}"
                                                            class="colorinput-input"
                                                            {{(isset($settings['invoice_color']) &&
                                                            $settings['invoice_color']==$color) ? 'checked' : '' }}>
                                                        <span class="colorinput-color"
                                                            style="background: #{{$color}}"></span>
                                                    </label>
                                                </div>
                                    ...
                                    <form id="setting-form" method="post" action="{{route('bill.template.setting')}}"
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select class="form-control" name="bill_template">
                                                @foreach(App\Models\Utility::templateData()['templates'] as $key =>
                                                $template)
                                                <option value="{{$key}}" {{(isset($settings['bill_template']) &&
                                                    $settings['bill_template']==$key) ? 'selected' : '' }}>{{$template}}
                                                </option>
                                                @endforeach
                                            </select>
                                        </div>
                                                ...
                                                <div class="col-auto">
                                                    <label class="colorinput">
                                                        <input name="bill_color" type="radio" value="{{$color}}"
                                                            class="colorinput-input" {{(isset($settings['bill_color'])
                                                            && $settings['bill_color']==$color) ? 'checked' : '' }}>
                                                        <span class="colorinput-color"
                                                            style="background: #{{$color}}"></span>
                                                    </label>
                                                </div>
                ...
                <div class="tab-pane fade" id="pills-purchase" role="tabpanel" aria-labelledby="pills-purchase-tab">
                    <div class="row company-setting">
                        <div class="col-md-3">
                            <div class="card-body">
                                <h5></h5>
                                <form id="setting-form" method="post" action="{{ route('purchase.template.setting') }}"
                                    enctype="multipart/form-data">
                                    @csrf
                                    <div class="form-group">
                                        ...
                                        <select class="form-control" name="purchase_template">
                                            @foreach (App\Models\Utility::templateData()['templates'] as $key =>
                                            $template)
                                            <option value="{{ $key }}" {{ isset($settings['purchase_template']) &&
                                                $settings['purchase_template']==$key ? 'selected' : '' }}>
                                                {{ $template }}</option>
                                            @endforeach
                                            ...
                                            <div class="col-auto">
                                                <label class="colorinput">
                                                    <input name="purchase_color" type="radio" value="{{ $color }}"
                                                        class="colorinput-input" {{ isset($settings['purchase_color'])
                                                        && $settings['purchase_color']==$color ? 'checked' : '' }}>
                                                    <span class="colorinput-color"
                                                        style="background: #{{ $color }}"></span>
                                                </label>
                                            </div>
                            ...
                            <div class="col-md-3">
                                <div class="card-body">
                                    ...
                                    <form id="setting-form" method="post"
                                        ...
                                        @csrf
                                        <div class="form-group">
                                            <label for="address" class="form-label">{{ __('Quotation Template')
                                                }}</label>
                                            <select class="form-control" name="quotation_template">
                                                @foreach (App\Models\Utility::templateData()['templates'] as $key =>
                                                $template)
                                                <option value="{{ $key }}" {{ isset($settings['quotation_template']) &&
                                                    $settings['quotation_template']==$key ? 'selected' : '' }}>
                                                    {{ $template }}</option>
                                                @endforeach
                                            </select>
                                        </div>
                                                ...
                                                <div class="col-auto">
                                                    <label class="colorinput">
                                                        <input name="quotation_color" type="radio" value="{{ $color }}"
                                                            class="colorinput-input" {{
                                                            isset($settings['quotation_color']) &&
                                                            $settings['quotation_color']==$color ? 'checked' : '' }}>
                                                        <span class="colorinput-color"
                                                            style="background: #{{ $color }}"></span>
                                                    </label>
                                                </div>
                                    ...
                                    <form id="setting-form" method="post" action="{{ route('pos.template.setting') }}"
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select class="form-control" name="pos_template">
                                                @foreach (App\Models\Utility::templateData()['templates'] as $key =>
                                                $template)
                                                <option value="{{ $key }}" {{ isset($settings['pos_template']) &&
                                                    $settings['pos_template']==$key ? 'selected' : '' }}>
                                                    {{ $template }}</option>
                                                @endforeach
                                            </select>
                                        </div>
                                                ...
                                                <div class="col-auto">
                                                    <label class="colorinput">
                                                        <input name="pos_color" type="radio" value="{{ $color }}"
                                                            class="colorinput-input" {{ isset($settings['pos_color']) &&
                                                            $settings['pos_color']==$color ? 'checked' : '' }}>
                                                        <span class="colorinput-color"
                                                            style="background: #{{ $color }}"></span>
                                                    </label>
                                                </div>
