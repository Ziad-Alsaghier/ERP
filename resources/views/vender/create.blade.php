...
{{ Form::text('balance', 0, ['class' => 'form-control', 'placeholder' => __('Enter Balance'), 'id' => 'balance']) }}
            </div>
        </div>
...
<script>
    ...
    balanceInput.addEventListener('input', function () {
        const value = parseFloat(balanceInput.value) || 0; // Parse value or default to 0
        balanceInput.value = value < 0 ? 0 : value; // Reset value to 0 if it's negative
    });
});
</script>