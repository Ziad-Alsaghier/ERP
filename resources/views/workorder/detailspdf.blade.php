@php
    ...
    $descriptionArray_details = $description;
    if(!is_array($descriptionArray_details)){
        $descriptionArray_details = json_decode($descriptionArray_details, true);
    }
    // dd($descriptionArray_details);
      ...
      <div class="row">
        <div class="eqWrap top-header">
          ...
          <div class="eq" style="width:100%; max-width:115px;">
            @if($settings_data['header_bill']){!! $settings_data['header_bill'] !!}
